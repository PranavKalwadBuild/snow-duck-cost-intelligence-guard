...
# Use our local MCP implementation
import snowflake_mcp.mcp.server.stdio
from snowflake_mcp.server import SnowflakeServer
...
async def start_service() -> None:
    ...
    try:
        ...
        async with snowflake_mcp.mcp.server.stdio.stdio_server() as (read_stream, write_stream):
            await server.run(
                read_stream,
                write_stream,
