...
from .tools.PutFile import PutFile
from .tools.GetTableMetadata import GetTableMetadata
from .tools.CreateStage import CreateStage
...
load_dotenv()
#hre
class SnowflakeConnection(ProcessReq,ListDatabases,ListSchemas,ListTables,DescribeTables,GetTableSample,GetColumnStats,SearchTables,SearchColumns,GetWarehouseInfo,InspectSchema,CheckDataQuality,AnalyzePerformance,CreateStoredProcedure,CompareTables,PutFile,GetTableMetadata,CreateStage):
    ...
    def __init__(self) -> None:
        ...
        self.config = {
             ...
             **({"password": os.getenv("SNOWFLAKE_PASSWORD")} if os.getenv("SNOWFLAKE_PASSWORD") else {"authenticator": os.getenv("SNOWFLAKE_AUTHENTICATOR") or os.getenv("AUTHENTICATOR")})
        }
